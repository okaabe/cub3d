...
#    Updated: 2023/01/16 02:57:07 by aamoussa         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS = main.c horz_rays.c ray_casting.c vert_rays.c minimap.c wall_projection.c wall_projection_utils.c minimap_utils.c ray_casting_utils.c floor.c parsing/parsing.c
